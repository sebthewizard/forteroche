...
<section id="hello-register">
	...
	<div id="hello-register-container">
		<div id="hello-register-content">
			...
			<p>Cette année j'ai décidé de vous faire lire mon dernier</p>
			<p>roman "Billet simple pour l'Alaska" directement en ligne.</p>
			<p>Il sera publié par épisode au fur et à mesure de sa rédaction</p>
			<p>Pour cela il vous suffit de vous inscrire !</p>
		</div>
	</div>
</section>
